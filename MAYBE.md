...
- byaccic (https://github.com/rofl0r/byaccic - berkeley yacc incompatible)
- c/c++ compiler stuff
...
- go-md2man (https://github.com/cpuguy83/go-md2man - .md to man page)
...
- go-sed (https://github.com/mk-milly02/go-sed - sed-ish in go)
- go-sed (https://github.com/zkry/go-sed - sed in go - compat?)
...
- neat/litcave stuff (http://litcave.rudi.ir/)
  - cell (https://github.com/aligrudi/cell)
  - dnsred (https://dev.rudi.ir/dnsred.tar.gz - dns redirect)
  ...
  - minimix (https://github.com/aligrudi/minmix)
  - neatas (https://repo.or.cz/neatas.git)
  - neatcc (https://github.com/aligrudi/neatcc)
    - neatcc_make (https://github.com/aligrudi/neatcc_make)
  ...
  - neatmail (https://github.com/aligrudi/neatmail)
...
- wak (https://github.com/raygard/wak - posix awk, for toybox too?)
