...
rfile="${rdir}.tar.gz"
rsha256="24160e7c3bfc6feecb9076706437fdb1212817549aaf9b4408f5a8e0b94e3eca"
...
rvermaj="${rver%%.*}"
rvermin="${rver#${rvermaj}.}"
rvermin="${rvermin%%.*}"
rurl="${rburl}/v${rvermaj}.${rvermin}/${rfile}"
unset rburl rvermaj rvermin
