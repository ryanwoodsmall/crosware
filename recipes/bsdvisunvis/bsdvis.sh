...
function cwfetch_${rname}() {
  cwfetchcheck \"http://cvsweb.netbsd.org/bsdweb.cgi/~checkout~/src/usr.bin/vis/vis.c?rev=${rver}\" \"${cwdl}/${rname}/vis.c\"    \"42d16bc5b8807085d8e585e6a6631fb472d6e9d20ffd3aac7abc7097009ed382\"
