...
rsha256="851e9b38192fe2ceaa65e0baa665e7fa06230c3d9bd1a6a9662d02380d73365a"
...
function cwmakeinstall_${rname}_readline() {
  ...
  (
    ...
    ./configure ${cwconfigureprefix} ${rconfigureopts} \
      --with-readline-ldflags=\"\${LDFLAGS} \${LIBS}\" \
      --with-readline-cflags=\"\${CPPFLAGS}\"
...
#      --disable-readline \
#      --disable-editline \
#      --with-linenoise=\"\$(cwbdir_${rname})/\$(cwdir_linenoise)\"
#    make -j${cwmakejobs} ${rlibtool}
#  )
#  cwmkdir \"\$(cwidir_${rname})/bin\"
