...
- 9pro (new home https://git.sr.ht/~ft/9pro , old https://git.sr.ht/~ft/9pro - 9p tools for unix)
...
- go
  ...
  - verions
    ...
    - go125 recipe with golang 1.25.x static binaries for all supported architectures
    - go126 recipe with golang 1.26.x static binaries for all supported architectures
    - go127 recipe with golang 1.27.x static binaries for all supported architectures
...
- scm (http://people.csail.mit.edu/jaffer/SCM.html and http://people.csail.mit.edu/jaffer/SLIB.html - scm scheme with slib library)
  ...
  - jacal (https://people.csail.mit.edu/jaffer/JACAL.html - symbolic math system)
